        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(menuComidaList.size() == 1){
                    ...
                    editor.putString("web_comida_seccion_6_caracteristica5_titulo", menuComidaList.get(4).getTitulo());
                    editor.putString("web_comida_seccion_6_caracteristica5_descripcion", menuComidaList.get(4).getDescripcion());
                    editor.putInt("web_comida_seccion_6_caracteristica5_precio", menuComidaList.get(4).getPrecio());
                }
                editor.commit();
                // ******************************************************************************
